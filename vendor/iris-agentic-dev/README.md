...
```powershell
Invoke-WebRequest -Uri "https://github.com/intersystems-community/iris-agentic-dev/releases/download/v1.4.2/iris-agentic-dev-windows-x86_64.exe" -OutFile "vendor\iris-agentic-dev\windows-x64\iris-agentic-dev.exe"
```
