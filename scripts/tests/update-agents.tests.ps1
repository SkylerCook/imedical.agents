...
Assert-True ($codingIrisManifest.version -eq "0.4.0") "coding iris plugin manifest should expose the iris-agentic-dev v1.2.6 integration"
...
Assert-True ($cureFormDevManifest.dependencyVersions.'coding-iris-plugin'.maxVersionExclusive -eq "0.5.0") "cure form plugin should accept coding iris v0.4"
