...
Assert-True ($codingIrisManifest.version -eq "0.5.2") "coding iris plugin manifest should expose guarded DEV-to-PRD demand promotion"
Assert-True ($cureFormDevManifest.name -eq "iris-cure-form-dev") "cure form plugin manifest should use the canonical name"
Assert-True ($cureFormDevManifest.version -eq "0.6.2") "cure form plugin manifest should accept the coding iris v0.5 compatibility range"
...
Assert-True ($cureFormDevManifest.dependencyVersions.'coding-iris-plugin'.maxVersionExclusive -eq "0.6.0") "cure form plugin should accept coding iris v0.5"
Assert-True ($irisCodegraphManifest.dependencyVersions.'coding-iris-plugin'.maxVersionExclusive -eq "0.6.0") "iris-codegraph should accept coding iris v0.5"
Assert-True ($interfaceDevManifest.dependencyVersions.'coding-iris-plugin'.maxVersionExclusive -eq "0.6.0") "interface plugin should accept coding iris v0.5"
...
Assert-True ($externalRegManifest.dependencyVersions.'coding-iris-plugin'.maxVersionExclusive -eq "0.6.0") "iris-external-reg should accept coding iris v0.5"
