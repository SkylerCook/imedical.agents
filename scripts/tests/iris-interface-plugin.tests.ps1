...
Assert-True (($manifest.legacyNames -contains "iris-interface-dev-plugin")) "manifest should declare the legacy plugin name"
...
Assert-Contains $skillContent "--output-root docs/interface" "doc-ingest adapter should use the current interface output root"
